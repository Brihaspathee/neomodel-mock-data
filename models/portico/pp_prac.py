...
if TYPE_CHECKING:
    ...
    from models.portico.pc_prac_insurance import PPPracInsurance
...
class PPPrac(Base):
    ...
    insurances: Mapped[List["PPPracInsurance"]] = relationship("PPPracInsurance", back_populates="practitioner")
