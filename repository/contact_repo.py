...
def create_address(contact: Contact):
    ...
    if contact.context.get_address() is not None:
        address = contact.context.get_address()
...
def create_telecom(contact: Contact):
    ...
    if contact.context.get_telecom() is not None:
        telecom = contact.context.get_telecom()
...
def create_hours_of_operation(contact: Contact):
    ...
    if contact.context.get_hours_of_operation() is not None:
        hours_of_operation = contact.context.get_hours_of_operation()
