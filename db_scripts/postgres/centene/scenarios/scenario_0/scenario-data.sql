...
INSERT INTO portown.pp_prov_attrib_values (id,prov_attribute_id,field_id,value,value_date,value_number,label_cluster_id) VALUES
	 ...
	 (33, 15, 100263, '78342344', NULL, NULL, NULL),
	 (34, 15, 100264, 'FL', NULL, NULL, NULL),
	 (35, 15, 100678, NULL, '2015-01-01', NULL, NULL),
	 (36, 15, 100679, NULL, '2018-12-31', NULL, NULL),
...
INSERT INTO portown.pp_prov_net_cycle (id,prov_id,net_id,status,start_date,end_date) VALUES
	 ...
	 (6,2,3258,'PAR','2015-01-01','4000-01-01'),
	 (7,2,3258,'PAR','2019-01-01','4000-01-01');
...
INSERT INTO portown.pp_prov_net_loc_cycle (id,prov_net_cycle_id,prov_id,loc_id,start_date,end_date,"PRIMARY") VALUES
	 (1,1,1,1,'2001-06-01','2011-06-30','N'),
...
INSERT INTO portown.pp_prov_net_loc_cycle (id,prov_net_cycle_id,prov_id,loc_id,start_date,end_date,"PRIMARY") VALUES
	 ...
	 (12,5,2,5,'2023-01-01','2023-03-31','N'),
	 (13,5,2,5,'2023-05-01','2023-12-31','N'),
	 (14,5,2,5,'2023-07-01','2023-10-31','N'),
	 (15,5,2,5,'2024-01-01','4000-01-01','N'),
	 (16,5,2,5,'2025-01-01','4000-01-01','N'),
	 (17,6,2,2,'2022-01-01','2022-12-31','N'),
     (18,6,2,2,'2023-03-01','2023-07-31','N'),
     (19,6,2,2,'2024-04-01','2024-12-31','N'),
     (20,6,2,2,'2025-02-01','2026-01-31','N'),
     (21,6,2,2,'2026-09-01','2027-06-30','N'),
     (22,6,2,2,'2027-11-01','4000-01-01','N'),
     (23,7,2,2,'2023-01-01','2023-12-31','N'),
     (24,7,2,2,'2023-09-01','2023-12-31','N'),
     (25,7,2,2,'2025-01-01','2025-12-31','N'),
     (26,7,2,2,'2026-04-01','2026-12-31','N'),
     (27,7,2,2,'2027-09-01','4000-01-01','N'),
     (28,7,2,2,'2028-02-01','2028-06-30','N');
...
-- Insert data HAS_PANEL, Accessibility nodes
INSERT INTO portown.pp_prov_loc_attrib (id,prov_id,loc_id,attribute_id) VALUES
	 (12,1,1,100087),
	 (13,1,1,100056),
	 (14,1,1,100057),
...
INSERT INTO portown.pp_prov_loc_attrib_values (id,prov_loc_attribute_id,field_id,value,value_date,value_number,label_cluster_id) VALUES
	 ('15',12,100309,'Y',NULL,NULL,NULL),
	 ('16',12,106215,'Y',NULL,NULL,NULL),
	 ('17',12,102575,'Y',NULL,NULL,NULL),
	 ('18',12,102576,'Y',NULL,NULL,NULL),
	 ('19',12,102578,'Y',NULL,NULL,NULL),
	 ('20',13,100269,'M',NULL,NULL,NULL),
	 ('21',14,100517,'M',NULL,NULL,NULL),
	 ('22',14,100518,'M',NULL,NULL,NULL),
	 ('23',14,100270,NULL,NULL,2,NULL),
	 ('24',14,100271,NULL,NULL,11,NULL),
	 ('25',15,100309,'Y',NULL,NULL,NULL),
	 ('26',15,106215,'Y',NULL,NULL,NULL),
	 ('27',15,102575,'Y',NULL,NULL,NULL),
	 ('28',15,102576,'Y',NULL,NULL,NULL),
	 ('29',15,102578,'Y',NULL,NULL,NULL),
	 ('30',15,102579,'Y',NULL,NULL,NULL),
	 ('31',15,102580,'Y',NULL,NULL,NULL),
	 ('32',15,102581,'Y',NULL,NULL,NULL),
	 ('33',15,102582,'Y',NULL,NULL,NULL),
	 ('34',15,102583,'Y',NULL,NULL,NULL),
	 ('35',15,106195,'Y',NULL,NULL,NULL),
	 ('36',15,106196,'N',NULL,NULL,NULL),
	 ('37',16,100269,'M',NULL,NULL,NULL),
	 ('38',17,100517,'Y',NULL,NULL,NULL),
	 ('39',17,100518,'Y',NULL,NULL,NULL),
	 ('40',17,100270,NULL,NULL,2,NULL),
	 ('41',17,100271,NULL,NULL,18,NULL),
	 ('42',18,100309,'Y',NULL,NULL,NULL),
	 ('43',18,106215,'Y',NULL,NULL,NULL),
	 ('44',18,102575,'Y',NULL,NULL,NULL),
	 ('45',18,102576,'Y',NULL,NULL,NULL),
	 ('46',18,102578,'Y',NULL,NULL,NULL),
	 ('47',18,102579,'Y',NULL,NULL,NULL),
	 ('48',18,102580,'Y',NULL,NULL,NULL),
	 ('49',18,102581,'Y',NULL,NULL,NULL),
	 ('50',18,102582,'Y',NULL,NULL,NULL),
	 ('51',18,102583,'N',NULL,NULL,NULL),
	 ('52',18,106195,'Y',NULL,NULL,NULL),
	 ('53',18,106196,'Y',NULL,NULL,NULL),
	 ('54',19,100269,'F',NULL,NULL,NULL),
	 ('55',20,100517,'Y',NULL,NULL,NULL),
	 ('56',20,100518,'Y',NULL,NULL,NULL),
	 ('57',20,100270,NULL,NULL,5,NULL),
	 ('58',20,100271,NULL,NULL,45,NULL),
	 ('59',21,100309,'Y',NULL,NULL,NULL),
	 ('60',21,106215,'Y',NULL,NULL,NULL),
	 ('61',21,102575,'Y',NULL,NULL,NULL),
	 ('62',21,102576,'Y',NULL,NULL,NULL),
	 ('63',21,102578,'Y',NULL,NULL,NULL),
	 ('64',21,102579,'N',NULL,NULL,NULL),
	 ('65',21,102580,'N',NULL,NULL,NULL),
	 ('66',21,102581,'Y',NULL,NULL,NULL),
	 ('67',21,102582,'Y',NULL,NULL,NULL),
	 ('68',21,102583,'Y',NULL,NULL,NULL),
	 ('69',21,106195,'Y',NULL,NULL,NULL),
	 ('70',21,106196,'Y',NULL,NULL,NULL),
	 ('71',22,100269,'M',NULL,NULL,NULL),
	 ('72',23,100517,'M',NULL,NULL,NULL),
	 ('73',23,100518,'M',NULL,NULL,NULL),
	 ('74',23,100270,NULL,NULL,2,NULL),
	 ('75',23,100271,NULL,NULL,8,NULL),
	 ('76',24,100309,'Y',NULL,NULL,NULL),
	 ('77',24,106215,'Y',NULL,NULL,NULL),
	 ('78',24,102575,'Y',NULL,NULL,NULL),
	 ('79',24,102576,'Y',NULL,NULL,NULL),
	 ('80',24,102578,'Y',NULL,NULL,NULL),
	 ('81',24,102579,'Y',NULL,NULL,NULL),
	 ('82',24,102580,'Y',NULL,NULL,NULL),
	 ('83',24,102581,'N',NULL,NULL,NULL),
	 ('84',24,102582,'Y',NULL,NULL,NULL),
	 ('85',24,102583,'Y',NULL,NULL,NULL),
	 ('86',24,106195,'Y',NULL,NULL,NULL),
	 ('87',24,106196,'Y',NULL,NULL,NULL),
	 ('88',25,100269,'F',NULL,NULL,NULL),
	 ('89',26,100517,'Y',NULL,NULL,NULL),
	 ('90',26,100518,'Y',NULL,NULL,NULL),
	 ('91',26,100270,NULL,NULL,5,NULL),
	 ('92',26,100271,NULL,NULL,99,NULL);
...
INSERT INTO portown.pp_prov_loc_attrib_values (id,prov_loc_attribute_id,field_id,value,value_date,value_number,label_cluster_id) VALUES
	 ('93',27,100309,'Y',NULL,NULL,NULL),
	 ('94',27,106215,'Y',NULL,NULL,NULL),
	 ('95',27,102575,'Y',NULL,NULL,NULL),
	 ('96',27,102576,'Y',NULL,NULL,NULL),
	 ('97',27,102578,'Y',NULL,NULL,NULL),
	 ('98',28,100269,'M',NULL,NULL,NULL),
	 ('99',29,100517,'M',NULL,NULL,NULL),
	 ('100',29,100518,'M',NULL,NULL,NULL),
	 ('101',29,100270,NULL,NULL,2,NULL),
	 ('102',29,100271,NULL,NULL,11,NULL),
	 ('103',30,100309,'Y',NULL,NULL,NULL),
	 ('104',30,106215,'Y',NULL,NULL,NULL),
	 ('105',30,102575,'Y',NULL,NULL,NULL),
	 ('106',30,102576,'Y',NULL,NULL,NULL),
	 ('107',30,102578,'Y',NULL,NULL,NULL),
	 ('108',30,102579,'Y',NULL,NULL,NULL),
	 ('109',30,102580,'Y',NULL,NULL,NULL),
	 ('110',30,102581,'Y',NULL,NULL,NULL),
	 ('111',30,102582,'Y',NULL,NULL,NULL),
	 ('112',30,102583,'Y',NULL,NULL,NULL),
	 ('113',30,106195,'Y',NULL,NULL,NULL),
	 ('114',30,106196,'N',NULL,NULL,NULL),
	 ('115',31,100269,'M',NULL,NULL,NULL),
	 ('116',32,100517,'Y',NULL,NULL,NULL),
	 ('117',32,100518,'Y',NULL,NULL,NULL),
	 ('118',32,100270,NULL,NULL,2,NULL),
	 ('119',32,100271,NULL,NULL,18,NULL),
	 ('120',33,100309,'Y',NULL,NULL,NULL),
	 ('121',33,106215,'Y',NULL,NULL,NULL),
	 ('122',33,102575,'Y',NULL,NULL,NULL),
	 ('123',33,102576,'Y',NULL,NULL,NULL),
	 ('124',33,102578,'Y',NULL,NULL,NULL),
	 ('125',33,102579,'Y',NULL,NULL,NULL),
	 ('126',33,102580,'Y',NULL,NULL,NULL),
	 ('127',33,102581,'Y',NULL,NULL,NULL),
	 ('128',33,102582,'Y',NULL,NULL,NULL),
	 ('129',33,102583,'N',NULL,NULL,NULL),
	 ('130',33,106195,'Y',NULL,NULL,NULL),
	 ('131',33,106196,'Y',NULL,NULL,NULL),
	 ('132',34,100269,'F',NULL,NULL,NULL),
	 ('133',35,100517,'Y',NULL,NULL,NULL),
	 ('134',35,100518,'Y',NULL,NULL,NULL),
	 ('135',35,100270,NULL,NULL,5,NULL),
	 ('136',35,100271,NULL,NULL,45,NULL),
	 ('137',36,100309,'Y',NULL,NULL,NULL),
	 ('138',36,106215,'Y',NULL,NULL,NULL),
	 ('139',36,102575,'Y',NULL,NULL,NULL),
	 ('140',36,102576,'Y',NULL,NULL,NULL),
	 ('141',36,102578,'Y',NULL,NULL,NULL),
	 ('142',36,102579,'N',NULL,NULL,NULL),
	 ('143',36,102580,'N',NULL,NULL,NULL),
	 ('144',36,102581,'Y',NULL,NULL,NULL),
	 ('145',36,102582,'Y',NULL,NULL,NULL),
	 ('146',36,102583,'Y',NULL,NULL,NULL),
	 ('147',36,106195,'Y',NULL,NULL,NULL),
	 ('148',36,106196,'Y',NULL,NULL,NULL),
	 ('149',37,100269,'M',NULL,NULL,NULL),
	 ('150',38,100517,'M',NULL,NULL,NULL),
	 ('151',38,100518,'M',NULL,NULL,NULL),
	 ('152',38,100270,NULL,NULL,2,NULL),
	 ('153',38,100271,NULL,NULL,8,NULL),
	 ('154',39,100309,'Y',NULL,NULL,NULL),
	 ('155',39,106215,'Y',NULL,NULL,NULL),
	 ('156',39,102575,'Y',NULL,NULL,NULL),
	 ('157',39,102576,'Y',NULL,NULL,NULL),
	 ('158',39,102578,'Y',NULL,NULL,NULL),
	 ('159',39,102579,'Y',NULL,NULL,NULL),
	 ('160',39,102580,'Y',NULL,NULL,NULL),
	 ('161',39,102581,'N',NULL,NULL,NULL),
	 ('162',39,102582,'Y',NULL,NULL,NULL),
	 ('163',39,102583,'Y',NULL,NULL,NULL),
	 ('164',39,106195,'Y',NULL,NULL,NULL),
	 ('165',39,106196,'Y',NULL,NULL,NULL),
	 ('166',40,100269,'F',NULL,NULL,NULL),
	 ('167',41,100517,'Y',NULL,NULL,NULL),
	 ('168',41,100518,'Y',NULL,NULL,NULL),
	 ('169',41,100270,NULL,NULL,5,NULL),
	 ('170',41,100271,NULL,NULL,99,NULL);
